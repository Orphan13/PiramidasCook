var player = new function() {
    ...
    this.y = 250;
    this.img = new Image();
    this.img.src = "Sprites/cookright.png";
    this.width = 80;
    this.height = 80;
    this.xSpeed = 6.7;
    this.ySpeed = 0;
    ...
    this.update = function() {
        if (!dead) {
            ...
            ctx.fillText("Упс...", screenWidth / 2, screenHeight / 2); 
            ctx.font = "36px Arial";
            ctx.fillText("Натисни SPASE", screenWidth / 2, (screenHeight / 2) + 50);
        }

        //A key pressed
        if (holdingLeftKey) {
            this.direction = "left";
            this.img.src = "Sprites/cookleft.png";
            player.moveLeft();
        }
        //D key pressed 
        if (holdingRightKey) {
